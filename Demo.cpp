...
int main() {
  // Create two players with their names 
   ...
   cout << game.get_draw() << " War for game" << endl;
   cout << p1.get_Losses() << " Losses p1" << endl;
   cout << p1.get_Wins() << " Wins p1" << endl;
   cout << p1.cardesTaken() << " cardesTaken() p1" << endl;
   cout << p1.stacksize() << " stacksize() p1" << endl;

   cout << p2.get_Losses() << " Losses p2" << endl;
   cout << p2.get_Wins() << " Wins p2" << endl;
   cout << p2.cardesTaken() << " cardesTaken() p2" << endl;
    cout << p2.stacksize() << " stacksize() p2" << endl;
}
